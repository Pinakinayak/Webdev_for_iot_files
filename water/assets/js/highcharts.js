...
(function() {
    ...
    var x, C = document,
        ...
        Pb = bb && parseInt(Fa.split("Firefox/")[1],
            10) < 4,
    ...
    va.prototype = {
                ...
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c))
                            for (e = l.length; e--;) z(l[e], c, c === "height" ? y(d - (l[e].cutHeight || 0), 0) : d);
        ...
        clip: function(a) {
            return this.attr("clip-path", a ? "url(" + this.renderer.url + "#" + a.id + ")" : R)//important
        },
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (aa !== this.cTT) {
                        if (t(j)) a.isSVG ? (q = Ca ? "-ms-transform" : tb ? "-webkit-transform" : bb ? "MozTransform" : Ib ? "-o-transform" : "", k[q] = k.transform = "rotate(" + j + "deg)") : (p = j * ab, u = V(p), p = Y(p), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=",
                            u, ", M12=", -p, ", M21=", p, ", M22=", u, ", sizingMethod='auto expand')"
                        ].join("") : R), H(b, k);
            ...
            n(c, function(c, d) {
                ...
                n(h, function(c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        da++;
                        if (i)
                            for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), t = []; c.length || t.length;) delete a.bBox, F = a.getBBox().width, m = F > i, !m || c.length ===
    ...
    Hb.prototype = {
        ...
        setOffset: function(a, b) {
            var c = this.axis,
                ...
                e = d.inverted,
                f = this.isNegative,
                g = c.translate(this.percent ? 100 : this.total, 0, 0, 0,
                    1),
                c = c.translate(0),
                c = L(g - c),
    ...
    ob.prototype = {
            ...
            n(a.series, function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        s = u.length;
                        for (f = 0; f < s; f++)
                            if (n = h[f], q = u[f], i && (w = (F = q < D) ? k : j, P = F ? p : l, q = w[n] = t(w[n]) ? ea(w[n] + q) : q, c[P] || (c[P] = {}), c[P][n] || (c[P][n] = new Hb(a, a.options.stackLabels, F, n, m, i)), c[P][n].setTotal(q)), q !== null && q !== x && (C && (q = g.modifyValue(q)), A || (h[f + 1] || n) >= z.min && (h[f - 1] || n) <= z.max))
                                if (n = q.length)
                                    for (; n--;) q[n] !== null && (r[v++] = q[n]);
                                else r[v++] = q;
        ...
        getMinorTickPositions: function() {
            ...
            if (this.isLog) {
                ...
                for (a = this.min + (a[0] - this.min) % b; a <=
            ...
            if (p) {
                ...
                for (e = p.length; e--;)
                    if (i = a.series[e ? "yAxis" : "xAxis"], p[e] && i)
                        if (i = i.getPlotLinePath(e ? o(a.stackY, a.y) : a.x, 1), this.crosshairs[e]) this.crosshairs[e].attr({
                            d: i,
                            visibility: "visible"
                        });
                        else {
                    ...
                    e && (n(c.axes, function(a) {
                        if (a.options.zoomEnabled !== !1) {
                            var b = a.isXAxis,
                                ...
                                d = a.translate((d ? h + g.width : c.plotHeight - l) - 2 * a.minPixelPadding, !0, 0,
                                    0, 1);
    ...
    rb.prototype = {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g)
                    for (j in g = a.convertAttribs(g), g) d = g[j],
                        d !== x && (i[j] = d);
                f.attr(i)
            }
        },
    ...
    sb.prototype = {
        ...
        getMargins: function() {
            ...
            if ((this.title || this.subtitle) && !t(this.optionsMarginTop))
                if (l = y(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !l.floating && !l.verticalAlign && l.y || 0)) this.plotTop =
    ...
    N.prototype = {
        ...
        translate: function() {
            ...
            for (var a = this.chart,
                    b = this.options, c = b.stacking, d = this.xAxis, e = d.categories, f = this.yAxis, g = this.points, h = g.length, i = !!this.modifyValue, j, k = f.series, l = k.length, m = b.pointPlacement === "between"; l--;)
                if (k[l].visible) {
                    k[l] === this && (j = !0);
                    break
                }
        ...
        drawPoints: function() {
            ...
            if (l.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled ===
                        x || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== x && !isNaN(e))
    ...
    G = ca(N, {
        ...
        getSegmentPath: function(a) {
            ...
            if (e.stacking && !this.closedStacks)
                for (d =
                    a.length - 1; d >= 0; d--) d < a.length - 1 && e.step && c.push(a[d + 1].plotX, a[d].yBottom), c.push(a[d].plotX, a[d].yBottom);
    ...
    ha = ca(N, {
        ...
        translate: function() {
            ...
            var l = a.points,
                g = L(g.transA) * (g.ordinalSlope || c.pointRange ||
                    g.closestPointRange || 1),
                m = g * c.groupPadding,
                p = (g - 2 * m) / f,
                u = c.pointWidth,
